        ...
        try:
            for el in data.split("\n"):
                ...
                if image_id in descriptions:
                    ...
                    descriptions[image_id]['wavs'] = [ cal_wav_path + image_id + '_' + str(cap_id) + '.wav' for cap_id in range(self.caption_count_per_image) ] 
...
#         pickle.dump(self.dictionary,open("full_dictionary.pkl","wb"))
    ...
    def __getitem__(self, index: int) -> (str, list, list):
        ...
        return self.dictionary[image_id]['im_path'], self.dictionary[image_id]['descs'], self.dictionary[image_id]['wavs']
